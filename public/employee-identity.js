...
await import('/exceptional-ui.js?v=20260809-1220');
import('/talent-intelligence-v2.js?v=20260809-1220');
import('/employee-edit.js?v=20260809-1220');
import('/system-admin.js?v=20260809-1220');
import('/master-map-v2.js?v=20260809-1220');
import('/promotion-readiness-center.js?v=20260809-1220');
import('/master-layout-v3.js?v=20260809-1220');