...
await import('/exceptional-ui.js?v=20260809-1241');
import('/talent-intelligence-v2.js?v=20260809-1241');
import('/employee-edit.js?v=20260809-1241');
import('/system-admin.js?v=20260809-1241');
import('/promotion-readiness-center.js?v=20260809-1241');
import('/master-layout-v3.js?v=20260809-1241');
import('/master-leadership-summary.js?v=20260809-1241');
// Map loads last so it upgrades the final Master layout instead of being replaced by later DOM moves.
setTimeout(()=>import('/master-map-v2.js?v=20260809-1241'),700);