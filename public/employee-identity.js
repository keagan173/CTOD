...
await import('/exceptional-ui.js?v=20260809-1202');
import('/talent-intelligence-v2.js?v=20260809-1202');
import('/employee-edit.js?v=20260809-1202');
import('/system-admin.js?v=20260809-1202');
import('/master-map-v2.js?v=20260809-1202');
import('/promotion-readiness-center.js?v=20260809-1202');